    ...
    <div id="app">
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex justify-content-between">
                        <div class="logo">
                            <a href="index.php"><img src="assets1/images/logo/logo.html" alt="Travela" srcset=""></a>
                        </div>
                        <div class="toggler">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>Cher ADMIN , vous étes le bienvenue</h3>
            </div>
                                ...
                                <div class="card">
                                    <div class="card-body px-3 py-4-5">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <h6 class="text-muted font-semibold">Evenements</h6>
                                            ...
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    <svg class="bi text-primary" width="32" height="32" fill="blue"
                                                        style="width:10px">
                                                        <use
                                                            xlink:href="assets1/vendors/bootstrap-icons/bootstrap-icons.svg#circle-fill" />
                                                    </svg>
                                                    <h5 class="mb-0 ms-3">Sousse</h5>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="assets1/images/faces/5.jpg">
                                                                </div>
                                                    ...
                                                    <tr>
                                                        <td class="col-3">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar avatar-md">
                                                                    <img src="assets1/images/faces/2.jpg">
                                                                </div>
                        ...
                        <div class="card">
                            <div class="card-body py-4 px-5">
                                <div class="d-flex align-items-center">
                                    >
                                    <div class="ms-3 name">
                                        <h5 class="font-bold">Acceder au site</h5>
                                        <a href="../frontOffice/register.php" class="text-muted mb-0">www.travela.tn</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-content pb-4">
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="assets1/images/faces/4.jpg">
                                    </div>
                                    <div class="name ms-4">
                                ...
                                <div class="recent-message d-flex px-4 py-3">
                                    <div class="avatar avatar-lg">
                                        <img src="assets1/images/faces/1.jpg">
                                    </div>
                                    <div class="name ms-4">
