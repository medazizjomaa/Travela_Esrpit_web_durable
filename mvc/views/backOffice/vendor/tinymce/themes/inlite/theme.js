...
var inlite = (function () {
    ...
    var editorHasTRAVELA = function (editor) {
    ...
    var togglePanel = function (editor, panel) {
      ...
      return function () {
        if (!editor.removed && editorHasTRAVELA(editor)) {
          toggle();
        }
      };
    };
    ...
    var bindContextualToolbarsEvents = function (editor, panel) {
      ...
      editor.shortcuts.add('Alt+F10,F10', '', panel.TRAVELA);
    };
    ...
    var TRAVELAFirstTextBox = function (form) {
