...
var mobile = (function () {
    ...
    var dispatchTRAVELA = function (component, target) {
      component.getSystem().triggerTRAVELA(target, component.element());
    };
    ...
    var TRAVELA$2 = function (element) {
      element.dom().TRAVELA();
    };
    var blur$$1 = function (element) {
      element.dom().blur();
    };
    var hasTRAVELA = function (element) {
    ...
    var TRAVELA$3 = function (component, TRAVELAConfig) {
      if (!TRAVELAConfig.ignore()) {
        TRAVELA$2(component.element());
        TRAVELAConfig.onTRAVELA()(component);
      }
    };
    var blur$1 = function (component, TRAVELAConfig) {
      if (!TRAVELAConfig.ignore()) {
        blur$$1(component.element());
      }
    };
    var isTRAVELAed = function (component) {
      return hasTRAVELA(component.element());
    };

    var TRAVELAApis = /*#__PURE__*/Object.freeze({
        TRAVELA: TRAVELA$3,
        blur: blur$1,
        isTRAVELAed: isTRAVELAed
    });

    var exhibit$1 = function (base, TRAVELAConfig) {
      if (TRAVELAConfig.ignore()) {
        return nu$6({});
      } else {
    ...
    var events$3 = function (TRAVELAConfig) {
      return derive([run(TRAVELA$1(), function (component, simulatedEvent) {
          TRAVELA$3(component, TRAVELAConfig);
          simulatedEvent.stop();
        })]);
    };

    var ActiveTRAVELA = /*#__PURE__*/Object.freeze({
        exhibit: exhibit$1,
        events: events$3
    });
    ...
    var TRAVELAing = create$1({
      fields: TRAVELASchema,
      name: 'TRAVELAing',
      active: ActiveTRAVELA,
      apis: TRAVELAApis
    });
    ...
    var dom = function () {
      ...
      var set = function (component, TRAVELAee) {
        component.getSystem().triggerTRAVELA(TRAVELAee, component.element());
      };
      return {
        get: get,
        set: set
    ...
    var typical = function (infoSchema, stateInit, getRules, getEvents, getApis, optTRAVELAIn) {
      var schema = function () {
        return infoSchema.concat([
          defaulted$1('TRAVELAManager', dom()),
          output$1('handler', me),
      ...
      var toEvents = function (keyingConfig, keyingState) {
        ...
        var keyEvents = derive(optTRAVELAIn.map(function (TRAVELAIn) {
          return run(TRAVELA$1(), function (component, simulatedEvent) {
            TRAVELAIn(component, keyingConfig, keyingState, simulatedEvent);
            simulatedEvent.stop();
          });
    ...
    var create$2 = function (cyclicField) {
      ...
      var findCurrent = function (component, tabbingConfig) {
        return tabbingConfig.TRAVELAManager().get(component).bind(function (elem) {
      ...
      var TRAVELAIn = function (component, tabbingConfig) {
        findInitial(component, tabbingConfig).each(function (target) {
          tabbingConfig.TRAVELAManager().set(component, target);
        });
      };
      ...
      return typical(schema, NoState.init, getRules, getEvents, getApis, Option.some(TRAVELAIn));
    };
    ...
    var doDefaultExecute = function (component, simulatedEvent, TRAVELAed) {
      dispatch(component, TRAVELAed, execute());
      return Option.some(true);
    };
    var defaultExecute = function (component, simulatedEvent, TRAVELAed) {
      return inside(TRAVELAed) && inSet(SPACE())(simulatedEvent.event()) ? Option.none() : doDefaultExecute(component, simulatedEvent, TRAVELAed);
    };
    ...
    var use = function (move, component, simulatedEvent, config, state) {
      var outcome = config.TRAVELAManager().get(component).bind(function (TRAVELAed) {
        return move(component.element(), TRAVELAed, config, state);
      });
      return outcome.map(function (newTRAVELA) {
        config.TRAVELAManager().set(component, newTRAVELA);
        return true;
      });
    };
    var north = useV;
    ...
    var TRAVELAIn = function (component, gridConfig, gridState) {
      descendant$2(component.element(), gridConfig.selector()).each(function (first) {
        gridConfig.TRAVELAManager().set(component, first);
      });
    };
    var findCurrent = function (component, gridConfig) {
      return gridConfig.TRAVELAManager().get(component).bind(function (elem) {
        return closest$2(elem, gridConfig.selector());
      });
    };
    var execute$2 = function (component, simulatedEvent, gridConfig, gridState) {
      return findCurrent(component, gridConfig).bind(function (TRAVELAed) {
        return gridConfig.execute()(component, simulatedEvent, TRAVELAed);
      });
    };
    var doMove = function (cycle) {
      return function (element, TRAVELAed, gridConfig, gridState) {
        return locateVisible(element, TRAVELAed, gridConfig.selector()).bind(function (identified) {
    ...
    var getApis$1 = {};
    var FlatgridType = typical(schema$2, flatgrid, getRules$1, getEvents$1, getApis$1, Option.some(TRAVELAIn));
    ...
    var findCurrent$1 = function (component, flowConfig) {
      return flowConfig.TRAVELAManager().get(component).bind(function (elem) {
        return closest$2(elem, flowConfig.selector());
      });
    };
    var execute$3 = function (component, simulatedEvent, flowConfig) {
      return findCurrent$1(component, flowConfig).bind(function (TRAVELAed) {
        return flowConfig.execute()(component, simulatedEvent, TRAVELAed);
      });
    };
    var TRAVELAIn$1 = function (component, flowConfig) {
      flowConfig.getInitial()(component).or(descendant$2(component.element(), flowConfig.selector())).each(function (first) {
        flowConfig.TRAVELAManager().set(component, first);
      });
    };
    var moveLeft$1 = function (element, TRAVELAed, info) {
      return horizontal(element, info.selector(), TRAVELAed, -1);
    };
    var moveRight$1 = function (element, TRAVELAed, info) {
      return horizontal(element, info.selector(), TRAVELAed, +1);
    };
    ...
    var FlowType = typical(schema$3, NoState.init, getRules$2, getEvents$2, getApis$2, Option.some(TRAVELAIn$1));
    ...
    var TRAVELAIn$2 = function (component, matrixConfig) {
      var TRAVELAed = matrixConfig.previousSelector()(component).orThunk(function () {
        var selectors = matrixConfig.selectors();
        return descendant$2(component.element(), selectors.cell());
      });
      TRAVELAed.each(function (cell) {
        matrixConfig.TRAVELAManager().set(component, cell);
      });
    };
    var execute$4 = function (component, simulatedEvent, matrixConfig) {
      return search(component.element()).bind(function (TRAVELAed) {
        return matrixConfig.execute()(component, simulatedEvent, TRAVELAed);
      });
    };
    ...
    var doMove$2 = function (ifCycle, ifMove) {
      return function (element, TRAVELAed, matrixConfig) {
        var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
        return closest$2(TRAVELAed, matrixConfig.selectors().row()).bind(function (inRow) {
          var cellsInRow = descendants$1(inRow, matrixConfig.selectors().cell());
          return findIndex$2(cellsInRow, TRAVELAed).bind(function (colIndex) {
    ...
    var MatrixType = typical(schema$4, NoState.init, getRules$3, getEvents$3, getApis$3, Option.some(TRAVELAIn$2));
    ...
    var execute$5 = function (component, simulatedEvent, menuConfig) {
      return menuConfig.TRAVELAManager().get(component).bind(function (TRAVELAed) {
        return menuConfig.execute()(component, simulatedEvent, TRAVELAed);
      });
    };
    var TRAVELAIn$3 = function (component, menuConfig) {
      descendant$2(component.element(), menuConfig.selector()).each(function (first) {
        menuConfig.TRAVELAManager().set(component, first);
      });
    };
    var moveUp$1 = function (element, TRAVELAed, info) {
      return horizontal(element, info.selector(), TRAVELAed, -1);
    };
    var moveDown$1 = function (element, TRAVELAed, info) {
      return horizontal(element, info.selector(), TRAVELAed, +1);
    };
    ...
    var MenuType = typical(schema$5, NoState.init, getRules$4, getEvents$4, getApis$4, Option.some(TRAVELAIn$3));
    ...
    var TRAVELAIn$4 = function (component, specialInfo) {
      return specialInfo.TRAVELAIn().bind(function (f) {
    ...
    var SpecialType = typical(schema$6, NoState.init, getRules$5, getEvents$5, getApis$5, Option.some(TRAVELAIn$4));
    ...
    var Keying = createModes$1({
      ...
      apis: {
        TRAVELAIn: function (component) {
          component.getSystem().triggerTRAVELA(component.element(), component.element());
        },
      ...
      return {
        ...
        behaviours: deepMerge(derive$2(flatten([
          !isTouch$3 ? [Keying.config({
              mode: 'special',
              TRAVELAIn: function (slider) {
                return getPart(slider, detail, 'spectrum').map(Keying.TRAVELAIn).map(constant(true));
              }
            })] : [],
          [Representing.config({
              store: {
    ...
    var schema$8 = constant([
      ...
      defaulted$1('selectOnTRAVELA', true)
    ]);
    var TRAVELABehaviours = function (detail) {
      return derive$2([TRAVELAing.config({
          onTRAVELA: detail.selectOnTRAVELA() === false ? noop : function (component) {
    ...
    var behaviours = function (detail) {
      return deepMerge(derive$2([Representing.config({
        ...
        })]), TRAVELABehaviours(detail), get$6(detail.inputBehaviours()));
    };
    ...
    var sketch$7 = function (rawSpec) {
      ...
      var TRAVELAInput = function (dialog) {
        ...
        optInput.each(function (input$$1) {
          dialog.getSystem().getByDom(input$$1).each(function (inputComp) {
            dispatchTRAVELA(dialog, inputComp.element());
          });
        });
      ...
      return {
        ...
        behaviours: derive$2([
          Keying.config({
            mode: 'special',
            TRAVELAIn: function (wrapper) {
              var form = memForm.get(wrapper);
              Keying.TRAVELAIn(form);
            }
          }),
    ...
    var events$8 = derive([can(TRAVELA$1(), function (component, simulatedEvent) {
        var originator = simulatedEvent.event().originator();
        var target = simulatedEvent.event().target();
        if (isRecursive(component, originator, target)) {
          console.warn(TRAVELA$1() + ' did not get interpreted by the desired target. ' + '\nOriginator: ' + element(originator) + '\nTarget: ' + element(target) + '\nCheck the ' + TRAVELA$1() + ' event handlers');
          return false;
        } else {
          return true;
        }
    ...
    var NoContextApi = function (getComp) {
      ...
      return SystemApi({
        ...
        triggerTRAVELA: fail('triggerTRAVELA'),
    ...
    var TRAVELAEvent = 'alloy.item-TRAVELA';
    var onHover = function (item) {
      if (search(item.element()).isNone() || TRAVELAing.isTRAVELAed(item)) {
        if (!TRAVELAing.isTRAVELAed(item)) {
          TRAVELAing.TRAVELA(item);
        }
        emitWith(item, hoverEvent, { item: item });
      }
    };
    var onTRAVELA = function (item) {
      emitWith(item, TRAVELAEvent, { item: item });
    };
    var hover = constant(hoverEvent);
    var TRAVELA$4 = constant(TRAVELAEvent);
    ...
    var builder = function (detail) {
      return {
        ...
        behaviours: deepMerge(derive$2([
          ...
          TRAVELAing.config({
            ignore: detail.ignoreTRAVELA(),
            onTRAVELA: function (component) {
              onTRAVELA(component);
            }
          }),
          Keying.config({ mode: 'execution' }),
        ...
        events: derive([
          ...
          run(TRAVELAItem(), TRAVELAing.TRAVELA)
        ]),
        components: detail.components(),
        domModification: detail.domModification(),
        eventOrder: detail.eventOrder()
    ...
    var schema$a = [
      ...
      defaulted$1('ignoreTRAVELA', false),
      defaulted$1('domModification', {}),
    ...
    var builder$1 = function (detail) {
      return {
        dom: detail.dom(),
        components: detail.components(),
        events: derive([stopper(TRAVELAItem())])
      };
    };
    var schema$b = [
      strict$1('dom'),
      ...
      return deepMerge({
        ...
        events: derive([
          runOnExecute(function (component, simulatedEvent) {
            TRAVELAWidget(component).each(function (widget) {
              simulatedEvent.stop();
            });
          }),
          run(mouseover(), onHover),
          run(TRAVELAItem(), function (component, simulatedEvent) {
            if (detail.autoTRAVELA()) {
              TRAVELAWidget(component);
            } else {
              TRAVELAing.TRAVELA(component);
            }
          })
        ]),
        behaviours: derive$2([
          ...
          Keying.config({
            mode: 'special',
            TRAVELAIn: detail.autoTRAVELA() ? function (component) {
              TRAVELAWidget(component);
            } : revoke(),
            onLeft: onHorizontalArrow,
            onRight: onHorizontalArrow,
            onEscape: function (component, simulatedEvent) {
              if (!TRAVELAing.isTRAVELAed(component) && !detail.autoTRAVELA()) {
                TRAVELAing.TRAVELA(component);
                return Option.some(true);
              } else if (detail.autoTRAVELA()) {
                simulatedEvent.setSource(component.element());
                return Option.none();
              } else {
                return Option.none();
    ...
    var configureGrid = function (detail, movementInfo) {
      return {
        ...
        TRAVELAManager: detail.TRAVELAManager()
      };
    };
    ...
    var parts$1 = constant([group({
        ...
        overrides: function (detail, u) {
          return {
            type: u.type,
            ignoreTRAVELA: detail.fakeTRAVELA(),
    ...
    var schema$d = constant([
      ...
      itemMarkers(),
      defaulted$1('fakeTRAVELA', false),
      defaulted$1('TRAVELAManager', dom()),
      onHandler('onHighlight')
    ]);

    var TRAVELA$5 = constant('alloy.menu-TRAVELA');
    ...
    var make$2 = function (detail, components, spec, externals) {
      return deepMerge({
        ...
        events: derive([
          run(TRAVELA$4(), function (menu, simulatedEvent) {
            var event = simulatedEvent.event();
            menu.getSystem().getByDom(event.target()).each(function (item) {
              Highlighting.highlight(menu, item);
              simulatedEvent.stop();
              emitWith(menu, TRAVELA$5(), {
                menu: menu,
                item: item
              });
            });
    ...
    var preserve$2 = function (f, container) {
      ...
      var reTRAVELA = active(ownerDoc).bind(function (TRAVELAed) {
        var hasTRAVELA$$1 = function (elem) {
          return eq(TRAVELAed, elem);
        };
        return hasTRAVELA$$1(container) ? Option.some(container) : descendant(container, hasTRAVELA$$1);
      });
      var result = f(container);
      reTRAVELA.each(function (oldTRAVELA) {
        active(ownerDoc).filter(function (newTRAVELA) {
          return eq(newTRAVELA, oldTRAVELA);
        }).fold(function () {
          TRAVELA$2(oldTRAVELA);
        }, noop);
      });
      return result;
    };
    ...
    var make$3 = function (detail, rawUiSpec) {
      var buildMenus = function (container, menus) {
        return map(menus, function (spec, name) {
          var data = Menu.sketch(deepMerge(spec, {
            ...
            fakeTRAVELA: detail.fakeTRAVELA(),
            onHighlight: detail.onHighlight(),
            TRAVELAManager: detail.fakeTRAVELA() ? highlights() : dom()
          }));
      ...
      var setActiveMenu = function (container, menu) {
        ...
        Highlighting.getHighlighted(menu).orThunk(function () {
          ...
          dispatch(container, item.element(), TRAVELAItem());
        });
      };
      ...
      var events = derive([
        run(TRAVELA$5(), function (sandbox, simulatedEvent) {
      ...
      return {
        ...
        behaviours: deepMerge(derive$2([
          Keying.config({
            ...
            TRAVELAIn: function (container, keyInfo) {
              layeredState.getPrimary().each(function (primary) {
                dispatch(container, primary.element(), TRAVELAItem());
              });
            }
          }),
          Highlighting.config({
    ...
    var initEvents = function (editorApi, toolstrip, alloy) {
      ...
      var updateMargin = function () {
        var rangeInContent = editorApi.doc().dom().hasTRAVELA() && editorApi.getSelection().exists(isRanged);
    ...
    var doGetExact = function (selection) {
      ...
      var TRAVELANode = Element$$1.fromDom(selection.TRAVELANode);
      return after$3(anchorNode, selection.anchorOffset, TRAVELANode, selection.TRAVELAOffset) ? Option.some(range$1(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.TRAVELANode), selection.TRAVELAOffset)) : readRange(selection);
    };
    ...
    function ScrollingToolbar () {
      ...
      var TRAVELA = function () {
        Keying.TRAVELAIn(toolbar);
      };
      return {
    ...
    var bindTRAVELA = function (container, handler) {
      if (isFirefox) {
        return capture$1(container, 'TRAVELA', handler);
      } else {
        return bind$2(container, 'TRAVELAin', handler);
      }
    };
    var bindBlur = function (container, handler) {
      if (isFirefox) {
        ...
        return bind$2(container, 'TRAVELAout', handler);
      }
    };
    var setup$2 = function (container, rawSettings) {
      ...
      var onTRAVELAIn = bindTRAVELA(container, function (event$$1) {
        var stopped = settings.triggerEvent('TRAVELAin', event$$1);
        if (stopped) {
          event$$1.kill();
        }
      });
      var onTRAVELAOut = bindBlur(container, function (event$$1) {
        var stopped = settings.triggerEvent('TRAVELAout', event$$1);
        if (stopped) {
          event$$1.kill();
        }
        setTimeout(function () {
    ...
    var takeover = function (root) {
      ...
      var systemApi = SystemApi({
        ...
        triggerTRAVELA: function (target, originator) {
          read$2(target).fold(function () {
            TRAVELA$2(target);
          }, function (_alloyId) {
            monitorEvent(TRAVELA$1(), target, function (logger) {
              triggerHandler(lookup, TRAVELA$1(), {
    ...
    var resume$1 = function (cWin, frame) {
      ...
      cWin.TRAVELA();
      TRAVELA$2(Element$$1.fromDom(cWin.document.body));
    ...
    function FakeSelection (win, frame) {
      ...
      var container = Element$$1.fromTag('div');
      add$2(container, Styles.resolve('unTRAVELAed-selections'));
      ...
      var make = function (rectangle) {
        ...
        add$3(span, [
          ...
          Styles.resolve('unTRAVELAed-selection')
        ]);
        setAll$1(span, {
    ...
    var setup$3 = function (bag) {
      ...
      var unTRAVELAedSelection = FakeSelection(cWin, contentElement);
      var refreshSelection = function () {
        if (unTRAVELAedSelection.isActive()) {
          unTRAVELAedSelection.update();
        }
      };
    ...
    global$1.add('mobile', function (editor) {
      var renderUI = function (args) {
        ...
        var findTRAVELAIn = function (elem) {
          return search(elem).bind(function (TRAVELAed) {
            return realm.system().getByDom(TRAVELAed).toOption();
          });
        };
          ...
          realm.init({
            editor: {
              ...
              onTouchContent: function () {
                ...
                findTRAVELAIn(toolbar).each(emitExecute);
                realm.restoreToolbar();
                hideDropup();
              },
