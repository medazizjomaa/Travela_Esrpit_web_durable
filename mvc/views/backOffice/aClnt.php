<?php
session_start();
// Si ce n'est pas déjà inclus (dans le layout par exemple), inclure la logique de gestion des messages
$error = $_SESSION['error'] ?? null;
$success = $_SESSION['success'] ?? null;
unset($_SESSION['error'], $_SESSION['success']);

$controller_path = "../../controllers/clientController.php"; // Ajustez ce chemin si nécessaire
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Remplissez les informations du nouveau client</h4>
            </div>
            ...
            <div class="card-body">
                ...
                <form action="<?= htmlspecialchars($controller_path) ?>" method="POST" class="form form-vertical">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="nom"><i class="bi bi-person-fill"></i> Nom du Client</label>
                                    <input type="text" id="nom" class="form-control" name="nom" placeholder="Nom de famille" required>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="form-group">
                                    <label for="prenom"><i class="bi bi-person-fill"></i> Prénom du Client</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="email"><i class="bi bi-envelope-fill"></i> Email (Identifiant)</label>
                                    <input type="email" id="email" class="form-control" name="email" placeholder="client@exemple.com" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="password" class="form-control" name="password" placeholder="Saisir un mot de passe" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="password" id="confirmPassword" class="form-control" name="confirmPassword" placeholder="Confirmer le mot de passe" required>
                                </div>
                            </div>

                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary me-1 mb-1">
                                    <i class="bi bi-person-plus-fill"></i> Ajouter le Client
                                </button>
