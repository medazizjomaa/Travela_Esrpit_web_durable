...
<div class="page-heading">
    <h3>Ajouter une Nouvelle Destination 🗺️</h3>
</div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Remplissez les informations de la Destination</h4>
            </div>
            <div class="card-body">
                <form action="../../controllers/destController.php?action=add" method="POST" class="form form-vertical">
                    <div class="form-body">
                        <div class="row">

                            <div class="col-12">
                                <div class="form-group">
                                    <label for="nom_dest"><i class="bi bi-pin-map-fill"></i> Nom de la Destination</label>
                                    <input type="text" id="nom_dest" class="form-control" name="nom_dest" placeholder="Ex: sousse,nabeul..." required>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="form-group">
                                    <label for="prix"><i class="bi bi-currency-euro"></i> Prix de Base (€)</label>
                                    <input type="number" id="prix" class="form-control" name="prix" placeholder="Prix minimum ou prix par nuit/personne" min="0" step="0.01" required>
                                </div>
                            </div>

                            <div class="col-12">
                                <div class="form-group">
                                    <label for="imageD"><i class="bi bi-image-fill"></i> URL/Chemin de l'Image</label>
                                    <input type="text" id="imageD" class="form-control" name="imageD" placeholder="Ex: images/sousse.jpg ou une URL" required>
                                </div>
                            </div>

                            <div class="col-12 d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary me-1 mb-1">
                                    <i class="bi bi-box-arrow-in-right"></i> Ajouter la Destination
                                </button>
