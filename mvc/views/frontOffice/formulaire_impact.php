...
<html lang="en">
         ...
         <div class="container-fluid destination py-5">
            <div class="container py-5">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">Calculateur d'impact écologique</h5>
    ...
    <form method="POST" action="../controllers/index.php?action=calculer">
        ...
        <input type="number" name="distance" required min="1">

        <label for="voyageurs">Nombre de voyageurs</label>
        <input type="number" name="voyageurs" required min="1">
        ...
        <button type="submit">Calculer l'impact 🌱</button>
    </form>
</div>
</div>
</div>
